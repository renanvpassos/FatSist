...
# ==========================================
LISTA_CLIENTES = [
    "DSV SAO", "DSV SAO MERCANTE", "DSV RIO", "DSV CPQ MERCANTE", "DSV ITJ QUINZENAL", "DSV CWB QUINZENAL", "DSV POA MERCANTE", "DSV POA MENSAL", "DIVERSOS EXPORTAÇÃO",
    "ZF-GROUP", "WARTSILA", "VITOPEL", "LPCO ROCHE", "LPCO MERCK", "LPCO SIGMA", "LPCO ABB", "LPCO LEGO", "LPCO LVMH", "LPCO CALIBRE", "DTA ROQUETTE", "DTA SERAL OTIS", "OTIS"
]
